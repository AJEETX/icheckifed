namespace risk.control.system.AppConstant
{
    public static class Applicationsettings
    {
        ...
        public const string COMPANY2NAME = "hdfc life";
        public const string COMPANY2CODE = "hdl";
        public const string COMPANY2DOMAIN = "hdfclife.com";
        ...
        public const string INDIA_CODE = "IND";
        public const string INDIA_NAME = "INDIA";

        public const string CLAIM_LOB = "CLAIMS";
        public const string UNDERWRITING_LOB = "UNDERWRITING";

        public static class INVESTIGATION_TYPE
        {
            public const string COMPREHENSIVE = "COMPREHENSIVE";
            public const string COMPREHENSIVE_CODE = "COMP";
            public const string NON_COMPREHENSIVE = "NON-COMPREHENSIVE";
            public const string NON_COMPREHENSIVE_CODE = "NON-COMP";
            public const string DOCUMENT_COLLECTION = "DOCUMENT-COLLECTION";
            public const string DOCUMENT_COLLECTION_CODE = "DOC";
            public const string DISCREET = "DISCREET";
            public const string DISCREET_CODE = "DISCREET";
        }
