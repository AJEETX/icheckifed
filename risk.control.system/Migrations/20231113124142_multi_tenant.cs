...
{
    /// <inheritdoc />
    public partial class multi_tenant : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VerifyOcr = table.Column<bool>(type: "bit", nullable: false),
                    ApiBaseUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PanIdfyUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    RapidAPIKey = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    RapidAPITaskId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    RapidAPIGroupId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Created = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Updated = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LocationPictureConfidence = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AgentOcrUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AgentOcrPicture = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    PanValid = table.Column<bool>(type: "bit", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ClientsClientCompanyId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    EmpanelledVendorsVendorId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
