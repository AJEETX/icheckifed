...
namespace risk.control.system.Seeds
{
    ...
    {
        public static async Task Seed(ApplicationDbContext context, string indiaCountryId, UserManager<ClientCompanyApplicationUser> userManager, string clientCompanyId)
        {
            //Seed client admin
