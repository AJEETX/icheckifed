...
namespace risk.control.system.Seeds
{
    ...
    {
        public static async Task Seed(ApplicationDbContext context, string indiaCountryId, UserManager<ApplicationUser> userManager, RoleManager<ApplicationRole> roleManager)
        {
